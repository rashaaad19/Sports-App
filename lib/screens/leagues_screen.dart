                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        leading: Image.network(
                          league.leagueLogo ?? widget.country.countryLogo ?? '',
                          width: 40.w,
                          height: 40.h,
                        ...
                        title: Text(league.leagueName ?? 'Unknown League', style: TextStyle(fontSize: 17.sp),),
                        subtitle: Text(
                          league.countryName ?? widget.country.countryName ?? 'Unknown Country',
